...
// Sets default values
APiezaSimpleBuilder::APiezaSimpleBuilder()
{
...
void APiezaSimpleBuilder::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void APiezaSimpleBuilder::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void APiezaSimpleBuilder::SpawnPieza()
{
...
APieces* APiezaSimpleBuilder::GetPiece()
{
	return Piece;
}
