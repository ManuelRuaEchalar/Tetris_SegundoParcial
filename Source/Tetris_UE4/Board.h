...
public:
    ...
    UPROPERTY()
        class APuntaje* Puntaje;

    class APiezaGrandeBuilder* PiezaGrandeBuilder;
    class ADirector* Director;
    class APiezaClasicaBuilder* PiezaClasicaBuilder;
    class APiezaSimpleBuilder* PiezaSimpleBuilder;

    class ADecoradorBloques* DecoradorBloques;

    class IComponenteObstaculo* Obstaculo;

    class AFacade* Facade;

    class AAsesino* Asesino;
    class ASuscriber* Suscriber1;
    class ASuscriber* Suscriber2;
    class AWallState* Wall;

    //IComponenteObstaculo* Obstaculo;
