...
void APieces::BeginPlay()
{
    ...
    BasicBlockFactory = GetWorld()->SpawnActor<AMyBasicBlockFactory>(AMyBasicBlockFactory::StaticClass());
...
void APieces::SpawnBlocks(FString TipoBloque, int CantidadBloques)
{
    int NumColor = FMath::RandRange(0, 6);
    std::vector<std::vector<std::pair<float, float>>> Shapes =
    {
        {{-20.0, 0.0}, {-10.0, 0.0}, {0.0, 0.0}, {10.0, 0.0}, {20.0, 0.0}, {30.0, 0.0}},
        {{0.0, 10.0}, {0.0, 0.0}, {10.0, 0.0}, {20.0, 0.0}, {30.0, 0.0}, {30.0, -10.0}},
        {{-20.0, 0.0}, {-10.0, 0.0}, {0.0, 0.0}, {0.0, 10.0}, {0.0, 20.0}, {10.0, 20.0}},
        {{0.0, 0.0}, {10.0, 0.0}, {0.0, -10.0}, {10.0, -10.0}, {10.0, -20.0}, {20.0, -20.0}},
        {{-10.0, -10.0}, {0.0, -10.0}, {0.0, 0.0}, {10.0, 0.0}, {10.0, 10.0}, {20.0, 10.0}},
        {{-10.0, 0.0}, {0.0, 0.0}, {0.0, 10.0}, {10.0, 0.0}, {10.0, -10.0}, {20.0, 0.0}},
        {{-10.0, 0.0}, {0.0, 0.0}, {0.0, -10.0}, {10.0, -10.0}, {10.0, -20.0}, {20.0, -20.0}},
    };
    ...
    // Limitar la cantidad de bloques a crear según CantidadBloques
    //const int NumBlocksToSpawn = FMath::Min(CantidadBloques, static_cast<int>(YZs.size()));
    ...
    for (int i = 0; i <CantidadBloques; ++i)
    {
        ...
        //BasicBlockFactory->SetColor(NumColor);
        B = BasicBlockFactory->OrderBlock(TipoBloque);
        //B->AsignarColor(NumColor);
        Blocks.Add(B);
